...
def validate(
    ...
    rule_context.push_issue(table=list_2, field="Gender", row=error_indices)
...
def test_validate():
    ...
    assert issues == [
        IssueLocator(SENTable.List_2, "Gender", 5),
        IssueLocator(SENTable.List_2, "Gender", 6),
    ]

    assert result.definition.code == "201b"
